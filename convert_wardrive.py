...
def convert_wardrive_logs(input_filenames, output_filename):
...
def main():
    ...
    parser.add_argument('input_filenames', nargs='+', help='Input file names containing wardrive results')
    parser.add_argument('output_filename', help='Output file name for the converted log')
    args = parser.parse_args()

    convert_wardrive_logs(args.input_filenames, args.output_filename)
